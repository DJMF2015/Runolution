...
export const FLYOVER_INTRO_DURATION_MS = 3400;
...
export const FLYOVER_INTRO_PULLBACK_METRES = 5000;
export const FLYOVER_INTRO_MIN_PULLBACK_ALTITUDE = 5500;
export const FLYOVER_INTRO_MAX_PULLBACK_ALTITUDE = 7200;
export const FLYOVER_INTRO_PULLBACK_PROGRESS = 0.42;
export const FLYOVER_INTRO_PULLBACK_PITCH = 46;
...
export const COMPACT_CORNER_MIN_TURN_DEGREES = 65;
export const COMPACT_CORNER_MIN_TURN_COUNT = 2;
export const COMPACT_CORNER_MIN_TOTAL_TURN_DEGREES = 170;
export const TIGHT_LOOP_DETECTION_DISTANCE_KM = 0.5;
export const TIGHT_LOOP_MAX_DIAMETER_KM = 0.25;
export const TIGHT_LOOP_MIN_TOTAL_TURN_DEGREES = 140;
